...
public class StatueMonster extends Monster {
     ...
     */
    public StatueMonster(String name, String description, EventPublisher<?> publisher, GameContext context, int healthPoints) throws UnsupportedAudioFileException, LineUnavailableException, IOException {
